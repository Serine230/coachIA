...
public class GeminiPromptHelper {
    ...
    // ── PROMPT : REFORMULER UN OBJECTIF ──────────────────
    public static String buildReformulationPrompt(String vagueGoal) {
        return "Tu es un coach de productivité. " +
                "L'utilisateur a cet objectif flou : '" + vagueGoal + "'. " +
                "Reformule-le en objectif SMART (Spécifique, Mesurable, Atteignable). " +
                "Réponds UNIQUEMENT en JSON : {\"smart_goal\": \"...\"}";
    }
